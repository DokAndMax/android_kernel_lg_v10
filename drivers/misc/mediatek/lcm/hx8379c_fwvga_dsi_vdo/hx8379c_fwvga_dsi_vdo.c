...
static void lcm_init(void)
{
       ...
       LCM_DBG( "[HX8379C_DSI] %s  esd init..\n", __func__ );
        SET_RESET_PIN(1);
	MDELAY(5); 
	SET_RESET_PIN(0);
	MDELAY(5); 
...
*/
        ...
        //------------------D6h----------------// 
         ...
         //------------------E0h----------------// 
                 ...
                 data_array[2] = 0x1D3F1511;//213F0C0C; 
                 data_array[3] = 0x0E0C0736;//0F0C0731; 
                 data_array[4] = 0x19140F18;//18161119; 
                 data_array[5] = 0x160B1818;//12081616; 
                 data_array[6] = 0x05001E17;//00001813; 
                 data_array[7] = 0x3F15110A;//3F0D0B00; 
                 data_array[8] = 0x0D08361C;//0D083120; 
                 data_array[9] = 0x1410180E;//1612190F; 
                 data_array[10] = 0x0B18181A;//08161619; 
                 data_array[11] = 0x001E1716;//00191414; 
...
static void lcm_suspend( void )
{
    ...
    LCM_DBG( "[HX8379C_DSI] %s.\n", __func__ );
    LCM_DBG( "[HX8379C_DSI] %s  esd suspend..\n", __func__ );
...
{
        printk("lcm_esd_recover  suspend \n");
	lcm_suspend();
        printk("lcm_esd_recover  init \n");
        lcm_init();
