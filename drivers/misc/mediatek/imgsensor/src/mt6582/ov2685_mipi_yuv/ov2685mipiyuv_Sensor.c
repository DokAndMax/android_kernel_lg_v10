...
OV2685_MIPI_write_cmos_sensor(0x5187,0x18); //tune sensory test awb 0c //1c //10 sarah 0504 daylight bluish
OV2685_MIPI_write_cmos_sensor(0x5188,0x12);   
OV2685_MIPI_write_cmos_sensor(0x5189,0x12); //0c sarah 0504 a light reddish specific
OV2685_MIPI_write_cmos_sensor(0x518a,0x0c); //tune sensory test awb 0c //10
OV2685_MIPI_write_cmos_sensor(0x518b,0x38);   
OV2685_MIPI_write_cmos_sensor(0x518c,0x44); //tune sensory test awb 24 //48 //40 sarah 0504 tl84 reddish
