...
static int S5K4H5YX_main_flag=0;
            ...
            if(DUAL_CAMERA_NONE_SENSOR != g_invokeSocketIdx[i]){
                ...
                if (sensorID == 0) {    //not implement this feature ID
                    ...
                    if(sensorID==S5K4H5YX_SENSOR_ID)
                        {
                                spin_lock(&kdsensor_drv_lock);
                                S5K4H5YX_main_flag=1;
                                spin_unlock(&kdsensor_drv_lock);
                                   PK_ERR("sensorID==S5K4H5YX_SENSOR_ID");
                        }
...
/*******************************************************************************
* verify main camera type
********************************************************************************/
int Camera_Verify_Type(void)
{
   if(S5K4H5YX_main_flag==1)
    {
    return 1;
    }
   else
   ...
   PK_ERR("[Camera_Verify_Type]    S5K4H5YX_main_flag =%d",S5K4H5YX_main_flag);
...
EXPORT_SYMBOL(Camera_Verify_Type);
