...
#define CHG_EN_DATA_OUT            GPIO45_DATAOUT // GPIO118_DATAOUT
 ...
 #define PGB_N                        (GPIO0| 0x80000000)//(GPIO119 | 0x80000000) //GPIO_EINT_CHG_STAT_PIN
 #define PGB_MODE                 GPIO_MODE_00 //GPIO_EINT_CHG_STAT_PIN_M_GPIO
 #define PGB_DIR                   GPIO0_DIR// GPIO119_DIR
 #define PGB_PULL_ENABLE  GPIO0_PULLEN// GPIO119_PULLEN
 #define PGB_PULL_SELECT   GPIO0_PULL//  GPIO119_PULL
 //>2015/5/4-davidda
...
//<2015/5/11-davidda, [v10][Feature][Common][BSP][]detect charger status
