...
#include "f_laf.c"
#endif /* End.. (CONFIG_USB_G_LGE_LAF) */
...
//<2015/01/20-Yuting Shih. Modified the VID and PID for the LGE united USB driver.
...
#endif /* End.. (CONFIG_LGE_USB_DRIVER) */
...
//<2015/02/24-Yuting Shih. [V10][Feature][Common][BSP][][] Modified for LGE unified USB driver.
#if !defined( CONFIG_USB_G_LGE_ANDROID )
...
//<2015/02/24-Yuting Shih. [V10][Feature][Common][BSP][][] Add for LGE unified USB driver.
#if 1 //defined( CONFIG_USB_G_LGE_LAF )
